...
const CarCard = ({ car }) => {
  return (
    <div className="car__card w-[300px] h-[430px] sm:w-[280px] md:w-[300px] sm:h-[430px] mx-auto my-1 text-center px-5 py-5 bg-stone-200 dark:bg-gray-900  dark:shadow-gray-800 rounded-3xl shadow-custom xl:hover:shadow-hover">
      <div className="h-[15%]">
